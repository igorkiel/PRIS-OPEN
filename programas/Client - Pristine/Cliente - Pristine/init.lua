-- CONFIG
APP_NAME = "Pristine"  -- important, change it, it's name for config dir and files in appdata
...
Servers = {
  ...
  OLD = "45.40.99.222:7171:1098"

}

--Server = "ws://otclient.ovh:3000/"
--Server = "ws://45.40.99.222:88/"
--USE_NEW_ENERGAME = true -- uses entergamev2 based on websockets instead of entergame
ALLOW_CUSTOM_SERVERS = true -- if true it shows option ANOTHER on server list

g_app.setName("Pristine")
-- CONFIG END
