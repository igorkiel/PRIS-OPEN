SpelllistSettings = {
  ['Default'] = {
    ...
    spellOrder = {'Animate Dead', 'Berserk', 'Cancel Invisibility', 'Challenge', 'Chameleon', 'Conjure Arrow', 'Conjure Bolt', 'Death Strike', 'Conjure Explosive Arrow', 'Conjure Piercing Bolt', 'Conjure Poisoned Arrow', 'Conjure Power Bolt', 'Conjure Sniper Arrow', 'Convince Creature', 'Creature Illusion', 'Cure Poison', 'Cure Poison Rune', 'Desintegrate', 'Destroy Field', 'Enchant Spear', 'Enchant Staff', 'Energy Beam', 'Energy Field', 'Energy Strike', 'Energy Wall', 'Energy Wave', 'Energybomb', 'Envenom', 'Ethereal Spear', 'Explosion', 'Fierce Berserk', 'Find Person', 'Fire Field', 'Fire Wall', 'Fire Wave', 'Fireball', 'Firebomb', 'Flame Strike', 'Food', 'Great Energy Beam', 'Great Fireball', 'Great Light', 'Groundshaker', 'Haste', 'Heal Friend', 'Intense Healing', 'Intense Healing Rune', 'Invisibility', 'Levitate', 'Light', 'Light Healing', 'Light Magic Missile', 'Magic Rope', 'Magic Shield', 'Magic Wall', 'Mass Healing', 'Paralyze', 'Poison Bomb', 'Poison Field', 'Poison Wall', 'Rage of the Skies', 'Soulfire', 'Strong Haste', 'Sudden Death', 'Summon Creature', 'Ultimate Healing', 'Ultimate Healing Rune', 'Ultimate Light', 'Whirlwind Throw', 'Wild Growth'}
  }--[[,
...
SpellInfo = {
  ['Default'] = {
    ...
    ['Energy Field'] =             {id = 27,  words = 'adevo grav vis',        exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'energyfield',            mana = 320,    level = 18, soul = 2, group = {[3] = 2000},               vocations = {1, 2, 5, 6}},    ['Great Fireball'] =           {id = 16,  words = 'adori gran flam',        exhaustion = 2000,  premium = false, type = 'Conjure', icon = 'greatfireball',          mana = 530,    level = 30, soul = 3, group = {[3] = 2000},               vocations = {1, 5}},
