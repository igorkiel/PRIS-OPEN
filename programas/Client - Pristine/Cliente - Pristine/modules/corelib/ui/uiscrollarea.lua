  ...
  if child then
    ...
    if self.verticalScrollBar then
      if child.getY then
        ...
        -- g_logger.error("Erro: child não possui o método getY")
      end
    elseif self.horizontalScrollBar then
      if child.getX then
        ...
        -- g_logger.error("Erro: child não possui o método getX")
      end
    else
      -- g_logger.error("Erro: ScrollBar não inicializado corretamente")
    end
  else
    -- g_logger.error("Erro: child é nil em ensureChildVisible")
  end
end
