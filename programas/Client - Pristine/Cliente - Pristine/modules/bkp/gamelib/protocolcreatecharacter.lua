-- protocolcreatecharacter.lua

-- @docclass
ProtocolCreateCharacter = extends(Protocol, "ProtocolCreateCharacter")

function ProtocolCreateCharacter:createCharacter(host, port, accountName, password, characterName, townId, sex, vocation)
...
function ProtocolCreateCharacter:sendCreateCharacterPacket()
  ...
  msg:addU8(self.townId)
  msg:addU8(self.sex)
  msg:addU8(self.vocation)
