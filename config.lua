...
maxPlayers = 0
motd = "Welcome to Pristine Online!"
...
deathLosePercent = -2 -- nao alterar, esta diretamente pela source (Igor)
...
mysqlHost = "127.0.0.1"
mysqlUser = "root"
mysqlPass = "anderson123"
mysqlDatabase = "oldtibia"
mysqlPort = 3306
mysqlSock = ""
passwordType = "sha1"
