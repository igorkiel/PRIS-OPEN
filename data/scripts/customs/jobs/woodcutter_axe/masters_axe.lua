...
local config = {
    ...
    [26611] = {break_chance = 75, loot_chance = 80, lower_tier = 26612, requiredSkill = 0, 
        normal_loot_table = { -- 80%
    ...
    [26610 ] = {break_chance = 75, loot_chance = 80, lower_tier = 26611, requiredSkill = 0, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26596, count = 1}, 
        },
        semi_rare_loot_table = { -- 15%
    ...
    [26614] = {break_chance = 75, loot_chance = 80, lower_tier = 26615, requiredSkill = 0, 
        normal_loot_table = { -- 80%
    ...
    [26613 ] = {break_chance = 75, loot_chance = 80, lower_tier = 26614, requiredSkill = 0, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26598, count = 1}, 
        },
        semi_rare_loot_table = { -- 15%
    ...
    [26608] = {break_chance = 75, loot_chance = 80, lower_tier = 26607, requiredSkill = 0, 
        normal_loot_table = { -- 80%
    ...
    [26609 ] = {break_chance = 75, loot_chance = 80, lower_tier = 26608, requiredSkill = 0, 
        normal_loot_table = { -- 80%
            [1] = {item_id = 26597, count = 1}, 
        },
        semi_rare_loot_table = { -- 15%
