...
local function creatureSayCallback(cid, type, msg)
    ...
    local player = Player(cid)
    local efreet = player:getStorageValue(Storage.DjinnWar.EfreetFaction.Mission03)
    local marid = player:getStorageValue(Storage.DjinnWar.MaridFaction.Mission03)
    ...
    elseif npcHandler.topic[cid] == 1 then
        if msgcontains(msg, 'malor') then
            ...
            player:addItem(2344, 1) -- Adiciona a lâmpada
