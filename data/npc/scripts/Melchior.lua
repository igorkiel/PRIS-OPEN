...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'Word of Greeting') then
		if player:getStorageValue(Storage.DjinnWar.Faction.Greeting) ~= 1 then
			...
			npcHandler:say("I have found out, though, that this does not work at all times. There is no point to say the word of greeting to an enraged djinn. ...", cid)
			npcHandler:say("I can tell you the word of greeting if you\'re interested. It is {DJANNI\'HAH}. Remember this word well, stranger. It might save your life one day. ...", cid)
