...
local function greetCallback(cid)
    -- Não faz nada no callback de saudação, uma vez que o NPC só responderá a "hail king" ou "salutations king"
    return false
end
...
local function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msg:lower(), "hail king") or msgcontains(msg:lower(), "salutations king") then
        ...
        npcHandler:say('Greetings, ' .. player:getName() .. ', what brings you before the King?', cid)
        return true
    end
