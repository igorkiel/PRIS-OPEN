...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'spy report') then
		...
		if reportProgress < 1 then
			...
			npcHandler:say("But - you know - now I have worked so hard on this report I somehow don\'t want to part with it. At least not without some decent payment. ...", cid)
