	...
	elseif npcHandler.topic[cid] == 1 then
		if msgcontains(msg, 'yes') then
			if player:getStorageValue(Storage.DjinnWar.MaridFaction.RataMari) ~= 2 or not player:removeItem(2345, 1) then
				npcHandler:say("Don\'t waste any more time. We need the spyreport of our man in Mal\'ouquah as soon as possible! ...", cid)
				npcHandler:say("Also don\'t forget the password to contact our man: PIEDPIPER!", cid)
			else
				...
				npcHandler:say("I think I need to talk to Gabel about this. I am sure he will know what to do. Perhaps you should have a word with him, too.", cid)
