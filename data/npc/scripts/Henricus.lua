...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "mission") or msgcontains(msg, "report") then
		...
		elseif player:getStorageValue(Storage.TheInquisition.Questline) == 3 then
			...
			npcHandler:say("I've arranged a flying carpet that will bring you to their hideout. Travel to Femor Hills and tell the carpet pilot the codeword 'eclipse' ...", cid)
		...
		elseif player:getStorageValue(Storage.TheInquisition.Questline) == 5 then
			if player:removeItem(8702, 1) then
				...
				npcHandler:say("Storkus is an old and grumpy dwarf who works as a vampire hunter since many, many decades. He's quite successful but even hehas his limits. ...", cid)
				npcHandler:say("So occasionally, we send him help. In return he trains and tests our recruits. It's an advantageous agreement for both sides ...", cid)
		...
		elseif player:getStorageValue(Storage.TheInquisition.Questline) == 17 then
			...
			npcHandler:say("Something that is a threat to all of us. Our investigators were able to acquire vital information before some of them were slain by a demon named Ungreez. ...", cid)
