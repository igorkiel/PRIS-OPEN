...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'mission') then
		if player:getStorageValue(Storage.DjinnWar.MaridFaction.Mission02) ~= 2 then
			npcHandler:say("So you would like to fight for us, would you. Hmm. ...", cid)
			npcHandler:say("That is a noble resolution you have made there, human, but I\'m afraid I cannot accept your generous offer at this point of time. ...", cid)
			npcHandler:say("Do not get me wrong, but I am not the kind of guy to send an inexperienced soldier into certain death! So you might ask around here for a more suitable mission.", cid)
