...
keywordHandler:addKeyword({'crunors caress'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Dont't ask. They were only an unimportant footnote of history."})
keywordHandler:addKeyword({'footnote'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "They thought they had to bring crunor to the people, if the peoople had not found crunor on their own. To achieve this, they founded the inn called Crunor's Cottage, south of Mt.Sternum."})
