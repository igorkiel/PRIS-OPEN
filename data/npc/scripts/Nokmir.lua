...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "ring") then
		if npcHandler.topic[cid] == 1 then
			npcHandler:say("On the next day, the guards brought me to emperor {Rehal}, and Rerun was there, too. He said I had stolen his ring. I'd never steal, you have to believe me.", cid)
