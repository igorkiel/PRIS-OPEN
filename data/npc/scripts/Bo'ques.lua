...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'cookbook') then
		if missionProgress == -1 then
			npcHandler:say("I'm preparing the food for all djinns in Ashta\'daramai. ...", cid)
			npcHandler:say("Therefore, I'm what is commonly called a cook, although I do not like that word too much. It is vulgar. I prefer to call myself \'chef\'.", cid)
	...
	elseif npcHandler.topic[cid] == 1 then
		if msgcontains(msg, 'yes') then
			...
			npcHandler:say("So, if you could bring me a cookbook of the dwarven kitchen, I\'ll reward you well.", cid)
