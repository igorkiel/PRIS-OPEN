...
local cities = {
    ["liberty bay"] = {cost = 400}
}
local kick_position = Position(32811, 31271, 6)
keywordHandler:addKeyword({'kick'}, StdModule.kick, {npcHandler = npcHandler, destination = {Position(32811, 31271, 6)}})
