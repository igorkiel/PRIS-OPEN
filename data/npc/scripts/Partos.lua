...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "ankrahmun") then
		...
		npcHandler:say("Unfortunately I had to relocate. <sigh> ...", cid)
...
keywordHandler:addKeyword({'prision'}, StdModule.say, {npcHandler = npcHandler, text = 'You mean that\'s a JAIL? They told me it\'s the finest hotel in town! THAT explains the lousy roomservice!'})
