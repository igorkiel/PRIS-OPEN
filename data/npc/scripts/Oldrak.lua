...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'mission') or msgcontains(msg, 'hallowed axe') then
	...
	elseif msgcontains(msg, 'demon oak') and player:getStorageValue(Storage.DemonOak.Done) == 1 then
