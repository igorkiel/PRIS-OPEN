...
keywordHandler:addKeyword({'crunors cottage'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Ah yes, I remember my grandfather talking about that name. This house used to be an inn a long time ago. My family bought it from some of these flower guys."})
keywordHandler:addKeyword({'flower guys'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Oh, I mean druids of course. They sold the cottage to my family after some of them died in an accident or something like that."})
...
keywordHandler:addKeyword({'stable'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "My grandpa told me, in the old days there were some behind this cottage. Nothing big though, just small ones, for chicken or rabbits."})
