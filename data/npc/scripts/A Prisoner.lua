...
function creatureSayCallback(cid, type, msg)
    ...
    local possible_numbers = {1, 13, 49, 94}
    ...
    elseif msgcontains(msg, 'yes') and talk_state == 3 then
        local random_number = possible_numbers[math.random(1, #possible_numbers)]
        npcHandler:say('So know that everything is based on the simple fact that 1 + 1 = ' .. random_number .. '!', cid)
        player:setStorageValue(6668, 1)
        player:setStorageValue(6669, random_number)
        talk_state = 0
