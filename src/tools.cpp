...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_CANNOTMOVETOGOLDPOUCH:
			return "You cannot move this item to the Gold Pouch.";
		...
		case RETURNVALUE_CANNOTMOVEITEMISNOTSTOREITEM:
			return "You cannot move this item into your Relic Box.";

		case RETURNVALUE_CANNOTMOVEITEMOFSAMEFAMILY:
			return "You cannot move this item into your Relic Box because you have some relic of same family.";
