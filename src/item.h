...
class Item : virtual public Thing
{
	public:
        ...
        void getTooltipData(const ItemType& it, TooltipDataContainer& tooltipData);
		...
		int32_t getAttributeValue(ItemTooltipAttributes_t id, int32_t type = -1) const;
		...
		static void getTooltipCombats(const ItemType& it, CombatType_t combatType, TooltipDataContainer& tooltipData);
		 static void addTooltipData(const ItemType& it, TooltipDataContainer& tooltipData, ItemTooltipAttributes_t id, int32_t value, int32_t type);
		...
		std::string getTooltipAttributeName(ItemTooltipAttributes_t attributeId, int32_t type = -1) const;

    std::string getResistanceDescription(int32_t type) const;

    // Nova função para descrever incrementos
    std::string getIncrementDescription(int32_t type) const;
