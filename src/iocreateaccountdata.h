...
class IOCreateAccountData
{
    ...
    static bool insertAccount(const std::string& accountName, const std::string& email, const std::string& password, const std::string& recoveryKey);
    static bool sendRecoveryKeyEmail(const std::string& email, const std::string& recoveryKey);
