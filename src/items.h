...
struct Abilities {
    ...
    std::array<int32_t, STAT_LAST + 1> statsBonus = {0}; // Novo array para bônus de stats

    // skill modifiers
    std::array<int32_t, SKILL_LAST + 1> skills = {0};
    std::array<int32_t, SKILL_LAST + 1> skillBonus = {0}; // Novo array para bônus de habilidades

    std::array<int32_t, SPECIALSKILL_LAST + 1> specialSkills = {0};

    int32_t speed = 0;

    int32_t armor = 0;        // Atributo de armadura
    int32_t armorBonus = 0;   // Bônus de armadura

    int32_t attack = 0;       // Atributo de ataque
    int32_t attackBonus = 0;  // Bônus de ataque

    int32_t defense = 0;      // Atributo de defesa
    int32_t defenseBonus = 0; // Bônus de defesa

    int32_t extraDefense = 0;      // Extra Defense (defesa adicional)
    int32_t extraDefenseBonus = 0; // Bônus de Extra Defense

    uint32_t attackSpeed = 0;      // Atributo de velocidade de ataque
    uint32_t attackSpeedBonus = 0; // Bônus de velocidade de ataque
    ...
    std::array<int16_t, COMBAT_COUNT> absorbPercentBonus = {0}; // Novo array para bônus de absorção de dano

    // elemental damage
    uint16_t elementDamage = 0;
    uint16_t elementDamageBonus = 0; // Bônus de dano elemental
