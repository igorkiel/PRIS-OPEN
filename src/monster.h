...
class Monster final : public Creature
{
	public:
		...
		void resetDamageToOriginal();
		void resetExperienceToOriginal();
        void addItem(uint16_t itemId, uint32_t count = 1);
		int32_t getMaxDamage() const;

		void setDamage(int32_t minDamage, int32_t maxDamage);
	

        int32_t getSpeed() const;
        void setSpeed(int32_t speed);
		void resetSpeedToOriginal(); 
         void setLootMultiplier(double multiplier);
         double getLootMultiplier() const;
	...
	private:
		...
		int32_t originalMinDamage;
		int32_t originalMaxDamage;
		int32_t originalExperience = 0;
